...
(function () {
  ...
  function ensureStage() {
    ...
    const hubLabel = new PIXI.Text('APPLE', { fontFamily: 'monospace', fontSize: 14, fill: 0xa78bfa, letterSpacing: 2, fontWeight: 'bold' });
  ...
  function onTick(delta) {
    ...
    hubCore.clear();
    hubCore.beginFill(0x0d0d10).lineStyle(2, 0xa78bfa, 1).drawCircle(0, 0, 54 * pulse).endFill();
    hubGlow.clear();
    hubGlow.beginFill(0xa78bfa, 0.06 + Math.sin(elapsed * 1.6) * 0.02).drawCircle(0, 0, 82).endFill();
